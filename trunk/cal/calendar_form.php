...
function submitNow(dvalue, mvalue, yvalue){
	...
	if($auto_submit){
		...
		if($form_name){
			...
			//echo("window.parent.refreshDate();\n");
		}
		echo("}\n");
	}
	?>
...
function loading(){
	document.getElementById('calendar-container').innerHTML = "<div id=\"calendar-body\"><div style=\"padding: 10px 2px 2px 2px;\"><div align=\"center\" style=\"background-color: #ffffff; height: 50px; padding: 25px; 10px 10px 10px;\">Refreshing Calendar...</div></div></div>";
	adjustContainer();
}
